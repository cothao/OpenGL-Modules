...
int main() {
    ...
    Shader shader = Shader("./modules/Advanced_Lighting/module_01_advanced_lighting/advanced_lighting_shader.vert", "./modules/Advanced_Lighting/module_01_advanced_lighting/advanced_lighting_shader.frag", nullptr);
