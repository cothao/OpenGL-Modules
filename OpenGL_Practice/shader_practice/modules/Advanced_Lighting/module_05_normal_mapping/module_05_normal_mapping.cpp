...
//
//    Shader shader = Shader("./modules/Advanced_Lighting/module_05_normal_mapping/normal_mapping_shader.vert", "./modules/Advanced_Lighting/module_05_normal_mapping/normal_mapping_shader.frag", nullptr);
//    Shader simpleDepthShader = Shader("./modules/Advanced_Lighting/module_05_normal_mapping/normal_mapping_simple_depth_shader.vert", "./modules/Advanced_Lighting/module_05_normal_mapping/normal_mapping_simple_depth_shader.frag", "./modules/Advanced_Lighting/module_05_normal_mapping/normal_mapping_simple_depth_shader.geom");
//
//    float planeVertices[] = {
...
//    unsigned int normalTexture = loadTexture("../images/brickwall_normal.jpg");
//
