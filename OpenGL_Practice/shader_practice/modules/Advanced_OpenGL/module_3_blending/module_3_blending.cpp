...
//
//    std::shared_ptr<Shader> shader = std::shared_ptr<Shader>(new Shader("./modules/Advanced_OpenGL/module_3_blending/blending_shader.vert", "./modules/Advanced_OpenGL/module_3_blending/blending_shader.frag"));
//    std::shared_ptr<Shader> shaderSingleColor = std::shared_ptr<Shader>(new Shader("./modules/Advanced_OpenGL/module_3_blending/blending_shader.vert", "./modules/Advanced_OpenGL/module_3_blending/shaderSingleColor.frag"));
//
//    /*
