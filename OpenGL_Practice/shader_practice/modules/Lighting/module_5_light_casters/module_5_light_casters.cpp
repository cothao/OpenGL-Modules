...
//
//
//    std::shared_ptr<Shader> lightingShader = std::shared_ptr<Shader>(new Shader("./modules/Lighting/module_5_light_casters/light_casters_shader.vert", "./modules/Lighting/module_5_light_casters/light_casters_shader.frag"));
//    std::shared_ptr<Shader> lightCubeShader = std::shared_ptr<Shader>(new Shader("./modules/Lighting/module_5_light_casters/light_casters_light_shader.vert", "./modules/Lighting/module_5_light_casters/light_casters_light_shader.frag"));
