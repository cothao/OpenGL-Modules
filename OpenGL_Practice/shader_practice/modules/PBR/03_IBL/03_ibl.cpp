...
int main()
{
    ...
    Shader shader("./modules/PBR/03_IBL/ibl.vert", "./modules/PBR/03_IBL/ibl.frag", nullptr);
    Shader equirectangularToCubemapShader("./modules/PBR/03_IBL/hdr.vert", "./modules/PBR/03_IBL/hdr.frag", nullptr);
    Shader irradianceShader("./modules/PBR/03_IBL/hdr.vert", "./modules/PBR/03_IBL/convolution.frag", nullptr);
    Shader cubemapShader("./modules/PBR/03_IBL/cubemapShader.vert", "./modules/PBR/03_IBL/cubemapShader.frag", nullptr);
...
// -------------
    ...
    unsigned int HDRTexture = loadHDRTexture("../images/photo_studio_loft_hall_4k.hdr");
    ...
    // create 6 views to map equirectangular scene to cubemap
    ...
    // configure irradiance map for calculating irradiance aronud hemisphere
